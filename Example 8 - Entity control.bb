...
;SE_CompileScript("Entity control.txt", "Entity control.sky")
;If SE_ERROR Then RuntimeError SE_ERROR_MESSAGE
;
;Local Script.SE_Script=SE_LoadScriptExec("Entity control.sky")

Local Script.SE_Script=SE_LoadScriptText("Entity control.txt")
If SE_ERROR Then RuntimeError SE_ERROR_MESSAGE
