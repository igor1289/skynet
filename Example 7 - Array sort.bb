...
;	Load script
;SE_CompileScript("Array sort.txt", "Array sort.sky")
;If SE_ERROR Then RuntimeError SE_ERROR_MESSAGE
;
;Local Script.SE_Script=SE_LoadScriptExec("Array sort.sky")

Local Script.SE_Script=SE_LoadScriptText("Array sort.txt")
If SE_ERROR Then RuntimeError SE_ERROR_MESSAGE
