...
;	Load script
;SE_CompileScript("Factorial.txt", "Factorial.sky")
;If SE_ERROR Then RuntimeError SE_ERROR_MESSAGE
;
;Local Script.SE_Script=SE_LoadScriptExec("Factorial.sky")

Local Script.SE_Script=SE_LoadScriptText("Factorial.txt")
If SE_ERROR Then RuntimeError SE_ERROR_MESSAGE
